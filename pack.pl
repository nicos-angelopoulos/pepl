...
keywords(['probabilistic logic programming','parameter estimation','machine learning']).
...
home( 'http://stoics.org.uk/~nicos/sware/pepl' ).
download( 'http://stoics.org.uk/~nicos/sware/packs/pepl/pepl-*.tgz' ).
